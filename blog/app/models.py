...
class Post(models.Model):
    ...
    # реализуется связь many-to-one, fk. CASCADE указывает что при удалении user удалятся и все данные
    ...
    # в модель также было добавлено новое поле status
    ...
    objects = models.Manager() # менеджер, прим. по умолчанию
