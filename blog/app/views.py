...
def post_list(request, tag_slug=None):
    ...
    # пограничная разбивка с 3 постами на страницу
    # извлечегте HTTP GET параметр. если нет page то загружаем 1 страницу
...
def post_comment(request, post_id):
    ...
    if form.is_valid():
        # создаем объект класса Comment не сохраняя в бд
